        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-8">
              With over a decade of experience in UI/UX design, I've had the privilege
              of working with clients across various industries, from startups to
              Fortune 500 companies. My passion lies in creating intuitive and
